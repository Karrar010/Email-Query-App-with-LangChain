"""
LangChain Setup Module with ChromaDB Vector Database
"""
import os
import chromadb
...
from config import OPENAI_API_KEY, CHROMA_DB_PATH, COLLECTION_NAME


class EmailVectorStore:
    """Manages email documents in ChromaDB vector store"""
